...
func TestStudyRootStudyIdentifierIncludesHorosSearchFields(t *testing.T) {
...
func TestPatientRootPatientIdentifierIncludesHorosSearchFields(t *testing.T) {
...
func TestStudyMatchFromIdentifierIncludesHorosDisplayFields(t *testing.T) {
...
func TestPatientMatchFromIdentifierIncludesHorosDisplayFields(t *testing.T) {
